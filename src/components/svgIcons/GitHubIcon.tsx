...
const GitHubIcon: React.FunctionComponent<Props> = props => (
  <svg viewBox="0 0 24 24" {...props}>
    <path
      d={
        ...
        '3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.' +
        '42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.' +
