...
describe("within allEntitiesSaga", () => {
  test("the createAllEntitiesSaga dispatches the correct actions", () => {
    return expectSaga(allEntitiesSaga)
      .put(allEntitiesActions.entityGroupInProcessChanged(EntityGroup.Clients))
      .call(clientsSagas.createClientsSaga)
      .put(allEntitiesActions.entityGroupInProcessChanged(EntityGroup.Tags))
      .call(tagsSagas.createTagsSaga)
      .put(allEntitiesActions.entityGroupInProcessChanged(EntityGroup.Projects))
      .call(projectsSagas.createProjectsSaga)
      .put(allEntitiesActions.entityGroupInProcessChanged(EntityGroup.Tasks))
      .call(tasksSagas.createTasksSaga)
      .put(allEntitiesActions.entityGroupInProcessChanged(EntityGroup.TimeEntries))
